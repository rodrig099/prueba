                                    ...
                                    <form id="main-form">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" id="user-search" class="form-control" placeholder="Ingrese el número de cédula del usuario" />
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label" for="message">Instrucciones</label>
